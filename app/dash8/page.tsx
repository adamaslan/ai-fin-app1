      ...
      <div className={`p-4 bg-gradient-to-br from-gray-800 to-gray-700 rounded-lg border-2 ${spreadColor}`}>
        ...
        <div className="grid grid-cols-2 gap-4 mb-3">
          <div className="p-3 bg-gray-800 rounded-lg">
            ...
            <div className="text-lg font-bold text-green-400">${spread.mid_premium}</div>
          </div>
          <div className="p-3 bg-gray-800 rounded-lg">
        ...
        {(spread.delta_sell !== null || spread.theta_sell !== null || spread.vega_sell !== null) && (
          <div className="mt-3 pt-3 border-t border-gray-600">
            ...
            <div className="flex gap-4 text-sm">
              {spread.delta_sell !== null && <span className="text-gray-300">Δ: {spread.delta_sell}</span>}
              {spread.theta_sell !== null && <span className="text-gray-300">Θ: {spread.theta_sell}</span>}
              {spread.vega_sell !== null && <span className="text-gray-300">ν: {spread.vega_sell}</span>}
            </div>
          </div>
        )}
      </div>
